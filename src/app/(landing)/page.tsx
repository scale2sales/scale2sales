...
const features = [
  {
    icon: '🔍',
    title: 'Trains on your website automatically',
    desc: 'Just enter your URL. We scan up to 20 pages and train the AI on your products, services, pricing, and FAQs — no manual setup needed.',
  },
  {
    icon: '⚡',
    title: 'Live on your site in 5 minutes',
    desc: 'Copy 2 lines of code and paste before </body>. Works on any website — WordPress, Shopify, Webflow, custom HTML.',
  },
  {
    icon: '💬',
    title: 'Answers customer questions instantly',
    desc: 'No more waiting for email replies. Your AI answers pricing, availability, features, and support questions the moment visitors ask.',
  },
  {
    icon: '🎯',
    title: 'Captures leads automatically',
    desc: 'The chatbot collects visitor names, emails, and intent — turning casual browsers into qualified leads while you sleep.',
  },
  {
    icon: '🎨',
    title: 'Fully customizable',
    desc: 'Match your brand colors, set a custom greeting, name your assistant, and position it anywhere on your page.',
  },
  {
    icon: '📊',
    title: 'Analytics & conversation history',
    desc: 'See every conversation, track token usage, and understand exactly what your visitors are asking about.',
  },
]

const testimonials = [
  {
    quote: 'We added Scale2Sales to our SaaS landing page and our trial signups went up 40% in the first week. Customers get answers instantly instead of emailing us.',
    name: 'Sarah Chen',
    title: 'Founder, DevTools Pro',
    avatar: 'SC',
    color: '#6366f1',
  },
  {
    quote: 'Our restaurant gets 50+ questions a day about hours, reservations, and menu. Scale2Sales answers all of them automatically. It paid for itself in 2 days.',
    name: 'Marcus Williams',
    title: 'Owner, The Harbor Grill',
    avatar: 'MW',
    color: '#0f6e56',
  },
  {
    quote: 'I was skeptical an AI could really understand our legal services, but it scanned our site and now answers client FAQs better than our old FAQ page ever did.',
    name: 'Jennifer Park',
    title: 'Managing Partner, Park Legal',
    avatar: 'JP',
    color: '#993556',
  },
]
...
const faqs = [
  ...
  { q: 'What if the AI doesn\'t know the answer?', a: 'You can customize the system prompt to tell the AI exactly what to do when it doesn\'t know something — like asking the visitor to contact you directly, or capturing their email for a follow-up.' },
  ...
  { q: 'How is my data protected?', a: 'All data is encrypted at rest and in transit. Each organization\'s data is completely isolated with row-level security. We never share your data or use it to train other customers\' AI.' },
]
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
          <Link
            href="/signup"
            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-brand-600 text-white font-semibold hover:bg-brand-700 transition-colors shadow-lg shadow-brand-200 text-lg"
          >
            Start for free — takes 5 minutes →
          </Link>
          <Link
            href="/tools/chatbot-tester"
            className="w-full sm:w-auto px-8 py-4 rounded-xl border border-gray-200 text-gray-700 font-semibold hover:bg-gray-50 transition-colors text-lg"
          >
            Try a live demo first
          </Link>
        </div>
        <p className="text-sm text-gray-400">
          Free plan available · No coding required · Works on any website
        </p>
      </section>
          ...
          {[
            {
              ...
              desc: 'Create a project and paste your website URL. Our AI scans up to 20 pages — about page, services, pricing, FAQs — and learns everything about your business.',
              color: 'bg-brand-50 text-brand-700',
            },
            {
              step: '02',
              title: 'Customize your chatbot',
              desc: 'Set your brand colors, greeting message, and widget name. Preview exactly how it will look on your website before going live.',
              color: 'bg-purple-50 text-purple-700',
            },
            {
              step: '03',
              title: 'Paste 2 lines of code',
              desc: 'Copy the embed snippet and paste it into your website\'s HTML. Works on WordPress, Shopify, Webflow, or any custom site.',
              color: 'bg-green-50 text-green-700',
            },
          ].map((item) => (
            <div key={item.step} className="relative">
              <div className={`inline-flex items-center justify-center w-12 h-12 rounded-2xl ${item.color} font-bold text-lg mb-4`}>
                {item.step}
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <div className="mb-5">
                  <p className={`text-sm font-semibold uppercase tracking-wide mb-1 ${plan.highlight ? 'text-brand-200' : 'text-gray-400'}`}>
                    {plan.name}
                  </p>
                  ...
                  {plan.annualPrice && (
                    <p className={`text-xs mt-1 ${plan.highlight ? 'text-brand-200' : 'text-gray-400'}`}>
                      or {plan.annualPrice}/mo billed annually — save 35%
                    </p>
                  )}
      ...
      <section className="bg-brand-600 py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-brand-200 text-xl mb-10 leading-relaxed">
            Every day without a chatbot is leads lost to competitors who answer faster. Get started free — no credit card required.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/signup"
              className="px-8 py-4 rounded-xl bg-white text-brand-600 font-bold hover:bg-brand-50 transition-colors text-lg"
            >
              Start for free — 5 minutes to launch →
            </Link>
            <Link
              href="/tools/chatbot-tester"
              className="px-8 py-4 rounded-xl border border-brand-400 text-white font-semibold hover:bg-brand-700 transition-colors text-lg"
            >
              Try demo first
            </Link>
          </div>
