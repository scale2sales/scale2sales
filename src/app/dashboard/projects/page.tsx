          ...
          <Card>
            <CardContent className="pt-6">
              <form action={createProject} className="space-y-4">
                <Input name="name" label="Project name" placeholder="My Website Bot" required />
                <Input name="website_url" label="Website URL" placeholder="https://mysite.com" type="url" />
                <div className="flex flex-col gap-1">
                  <label className="text-sm font-medium text-gray-700">Description</label>
                  <Textarea name="description" placeholder="What this chatbot is for..." rows={2} />
                </div>
                <div className="flex flex-col gap-1">
